...
<div class="fieldcontain ${hasErrors(bean: ventas, field: 'cantidad', 'error')} required">
  ...
  <g:field name="cantidad" type="number" min="0" value="${ventas.cantidad}" required=""/>
</div>
...
<!--
<div class="fieldcontain ${hasErrors(bean: ventas, field: 'precioUnitario', 'error')} required">
  <label for="precioUnitario">
    <g:message code="ventas.precioUnitario.label" default="Precio Unitario" />
    <span class="required-indicator">*</span>
  </label>
  <g:field name="precio" value="${fieldValue(bean: ventas, field: 'precio')} * ${fieldValue(bean: )}" required=""/>
</div>-->
